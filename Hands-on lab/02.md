...
3. Click on **click here** under **Select assessment tool** and select **Azure Migrate: Database Assessment**, then select **Next**.
...
4. Click on **click here** under **Select migration tool** and  select **Azure Migrate: Database Migration**, then select **Next**.
...
8. Open **Chrome** from the desktop and paste the Data Migration Assistant download URL into the address bar. Download and install the Data Migration Assistant.
...
9.  Select the **SmartHotel-DB-for-DMS** endpoint added earlier, and select **Remove**. In the confirmation dialog, select **yes**.
