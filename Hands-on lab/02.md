...
1. Open the Azure Cloud Shell by navigating to **https:<span></span>//shell.azure.com**. Log in using your Azure subscription credentials if prompted to do so, select a **PowerShell** session, and accept any prompts.
...
3. The **Create SQL Database** blade opens, showing the **Basics** tab. Complete the form as follows:
    ...
    > **Note**: You can verify the location by opening another browser tab, navigating to **https:<span></span>//portal.azure.com** and selecting Virtual Machines on the left navigation. Use the same region as the **SmartHotelHost** virtual machine.
...
7. Select **Download** to open the Data Migration Assistant download page. 

8. Download and install the Data Migration Assistant.
