...
6. **Wait.** After a minute or two, an Microsoft Edge browser will open showing the Azure Migrate appliance configuration wizard. Click on I Agree button and it will start setting up the prerequisites.(If you see any popup related to the new update, please click on refresh button)
...
11. Under **Manage credentials and discovery sources**, Click on **Add Credentials** Enter Friendly name **Smarthotel**, Enter Username as **demouser** and Password as **demo!pass123** and click on Save button.

    ![Screenshot of the Azure Migrate appliance configuration wizard, showing the prompt to enter username and password.](images/Exercise1/Ex1task3.11.png)
